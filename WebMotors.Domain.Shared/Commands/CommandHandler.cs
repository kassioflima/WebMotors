...
public class CommandHandler(IUnitOfWork uow, IHandler<DomainNotification> notifications, ILogger logger) : Notifiable<Notification>
{
    private readonly IUnitOfWork _uow = uow;
    private readonly IHandler<DomainNotification> _notifications = notifications;
