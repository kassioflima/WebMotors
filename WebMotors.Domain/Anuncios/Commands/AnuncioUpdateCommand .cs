...
{
    public class AnunciUpdateCommand : Notifiable<Notification>, ICommand
    {
        ...
        {
            AddNotifications(new Contract<AnunciUpdateCommand>()
                .Requires()
                .IsGreaterThan(Id, 1, "Id", "O campo id deve ser maior que zero.")
